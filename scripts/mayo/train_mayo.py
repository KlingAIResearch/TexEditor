...
def eval_fn(
    ...
    all_out_list = []
    all_prompts = []
    all_rewards_cur = {'pixel_loss':[], 'avg':[]}
...
def main(_):
    ...
    dit_state = load_state_dict("/mmu-vcg/zb08/codes/DiffSynth-Studio-main/models/train/Qwen-Image-Edit-2509_full_mayo/epoch-4.safetensors")
    ...
    import reward_mayo
    reward_fn = reward_mayo.multi_score(device, config.reward_fn)
    eval_reward_fn = reward_mayo.multi_score(device, config.reward_fn)
