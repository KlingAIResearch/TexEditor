...
class PromptImageDataset(Dataset):
    ...
    def collate_fn(examples):
        ...
        return prompts, metadatas, images, prompt_with_image_paths, names
...
def eval_fn(
    ...
    for test_batch in tqdm(
        ...
        prompts, prompt_metadata, ref_images, prompt_with_image_paths, names = test_batch
    ...
    dst_folder = os.path.join('/mmu-vcg/zb08/outputs/texture_edit/aa_debug_flux', now_str.replace(' ', '_').replace(':', '-')+f'_eval')
    ...
    for idx, item in enumerate(zip(all_prompts, all_ref_list, all_out_list, all_names)) :
        prompt, ref_image, edited_image, name = item
...
def main(_):
    ...
    lora_path = '/mmu-vcg/zb08/codes/UniWorld-main/UniWorld-V2/logs/nft/kontext/zb_mayo_2_8/checkpoints/checkpoint-12/lora'
