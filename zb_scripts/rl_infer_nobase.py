...
def main(_):
    ...
    lora_path = '/mmu-vcg/zb08/codes/UniWorld-main/UniWorld-V2/logs/nft/qwen_image_edit/zb_sft_base_bigbs_Coco_normal_kl_allwash_abla_nosft/checkpoints_2026.01.14_09.04.46/checkpoint-36/lora'
