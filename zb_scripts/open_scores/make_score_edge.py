...
if __name__ == "__main__":
    ...
    dst_foldr_all = 'the folder path of edge scores'
    ...
    # the folder path of source images
    source_imgs_f = '/mmu-vcg/zb08/yihang/enhance_coco_data_12_25/new_data/new_data_texture'

    # the list and dict of edited image folders, you can modify the list and dict if you want to calculate edge scores for different folders
    ...
    # Finish configuration, start calculating edge scores
