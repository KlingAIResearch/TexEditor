...
class PromptImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        cur_id = self.metadatas[idx]["index"]
    ...
    def collate_fn(examples):
        ...
        ids = [example["metadata"]["index"] for example in examples]
        prompt_with_image_paths = [
            example["prompt_with_image_path"] for example in examples
        ]
        return prompts, metadatas, images, prompt_with_image_paths, ids
...
def eval_fn(
    ...
    for test_batch in tqdm(
        ...
        prompts, prompt_metadata, ref_images, prompt_with_image_paths, ids = test_batch
    ...
    for idx, item in enumerate(zip(all_prompts, all_ref_list, all_out_list, all_ids)) :
        prompt, ref_image, edited_image, cur_id = item

        img_name = os.path.join(f'{cur_id}.png')
...
def main(_):
    ...
    # test_dataset = PromptImageDataset(config.dataset, config.resolution, "texture_index")
