...
if __name__ == "__main__":
    ...
    dst_foldr_all = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/all_edges_125_morev2/score'
    ...
    dst_dir_f = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/all_edges_125_morev2/more'
    os.makedirs(dst_dir_f, exist_ok=True)

    # rl = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.05_14.31_0_eval_rl_more_36_test_20dpm_texture/edited' # 这个是之前的  这次不打算带 

    # rl_72 = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.13_12.16_0_eval_resume_72_texture/edited'
    # rl_64 = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.13_15.05_0_eval_resume_64_texture/edited'
    # nobase_rl = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.14_10.48_0_eval_nobase_sft_texture/edited'

    # rl_96 = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.10_22.03_0_eval_92rl_texture/edited'
    # alchemist = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.16_14.14_0_eval_alchemist_texture/edited'

    g2 = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/gemini-2.5-flash/simple_blender_test_more'
    g3 = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/gemini-3-flash/simple_blender_test_more'
    qwen_2509 = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.22_10.49_0_eval_origin_more_index_simple/edited'
    rl = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.25_11.51_0_eval_rl_more/edited'

    # 先弄texture
    # 这个感觉 texture 和 属性还是分开写吧  

    in_json_p = '/mmu-vcg/zb08/outputs/texture_edit/train_data/simple_blender_test/more_index.jsonl'
    with open(in_json_p, 'r') as f:
        lines = f.readlines()
    data = [json.loads(line) for line in lines]


    # img_folder_dict = { "g2": g2, "g3": g3, "qwen_2509": qwen_2509}
    img_folder_dict = {"rl": rl,"g2": g2, "g3": g3, "qwen_2509": qwen_2509}
    ...
    for k in img_folder_dict:
        ...
        for cur_name in tqdm(sub_names) :
            ccccur_id = int(cur_name.split('.')[0])-1
            ttt = data[ccccur_id]
            src_p = ttt['edit_image']
