...
if __name__ == "__main__":
    ...
    # dst_foldr1 = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores_final/g2_simple_blender_more_v2'
    # dst_foldr2 = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores_final/g3_simple_blender_more_v2'
    # dst_foldr3 = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores_final/2509_simple_blender_more_v2'

    dst_foldr1 = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores_final/rl_pure_gemini_dpm20_more'
    dst_foldr2 = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores_final/rl_pure_edge_dpm20_more'

    # dst_foldr4 = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores_final/2509_dpm20_more_g3'
    # dst_foldr5 = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores_final/sftour_dpm20_more_g3'
    # dst_foldr6 = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores_final/2511_dpm20_more_g3'

    os.makedirs(dst_foldr1, exist_ok=True)
    os.makedirs(dst_foldr2, exist_ok=True)
    # os.makedirs(dst_foldr3, exist_ok=True)
    # os.makedirs(dst_foldr4, exist_ok=True)
    # os.makedirs(dst_foldr5, exist_ok=True)
    # os.makedirs(dst_foldr6, exist_ok=True)

    # 输入图像与指令都是一样的
    # in_p = '/mmu-vcg/zb08/outputs/texture_edit/train_data/simple_blender_test/more_index.jsonl'
    in_p = '/mmu-vcg/zb08/outputs/texture_edit/train_data/rl_data/maybe_v2_final_more/test_clean_v2.jsonl'

    # dst_img_p1 = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.13_13.22_0_eval_resume_72_more/edited'
    # dst_img_p2 = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/gemini-3/final_coco_more'
    # dst_img_p3 = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/gemini-2.5/final_coco_more'
    # dst_img_p4 = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.04_13.58_0_eva_origin_dpm_20_more_test/edited'
    # dst_img_p5 = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.04_13.15_0_eval_sftbase_dpm20_more-test_real/edited'
    # dst_img_p6 = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.05_17.10_0_eval_2511_base_more_dmp20/edited'
    
    # dst_img_p1 = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/gemini-2.5-flash/simple_blender_test_more'
    # dst_img_p2 = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/gemini-3-flash/simple_blender_test_more'
    # dst_img_p3 = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.22_10.49_0_eval_origin_more_index_simple/edited'

    dst_img_p1 = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.23_13.12_0_eval_pure_gemini_more/edited'
    dst_img_p2 = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.23_13.41_0_eval_pure_edge_more/edited'


    # os.makedirs(dst_img_p1, exist_ok=True)
    # os.makedirs(dst_img_p2, exist_ok=True)
    # os.makedirs(dst_img_p3, exist_ok=True)
    # os.makedirs(dst_img_p4, exist_ok=True)
    # os.makedirs(dst_img_p5, exist_ok=True)
    # os.makedirs(dst_img_p6, exist_ok=True)
    ...
    # dst_foldr_list = [ dst_foldr1, dst_foldr2, dst_foldr3, dst_foldr4, dst_foldr5, dst_foldr6]
    # dst_img_p_list = [ dst_img_p1, dst_img_p2, dst_img_p3, dst_img_p4, dst_img_p5, dst_img_p6]
    dst_foldr_list = [ dst_foldr1, dst_foldr2]
    dst_img_p_list = [ dst_img_p1, dst_img_p2]
    # dst_foldr_list = [ dst_foldr1, dst_foldr2, dst_foldr3]
