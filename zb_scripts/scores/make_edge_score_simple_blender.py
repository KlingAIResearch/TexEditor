...
if __name__ == "__main__":
    ...
    dst_foldr_all = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/all_edges_125/score'
    ...
    dst_dir_f = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/all_edges_125/texture'
    ...
    # g2 = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/gemini-2.5-flash/simple_blender_test_texture'
    # g3 = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/gemini-3-flash/simple_blender_test_texture'
    # qwen_2509 = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.22_11.01_0_eval_origin_texture_index_simple/edited'

    rl = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.25_01.02_0_eval_rl_texture/edited'

    # 先弄texture
    # 这个感觉 texture 和 属性还是分开写吧  

    in_json_p = '/mmu-vcg/zb08/outputs/texture_edit/train_data/simple_blender_test/texture_index.jsonl'
