...
if __name__ == "__main__":
    ...
    dst_foldr = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores/nobase_rl_dpm20_more_g3'
    # dst_foldr = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores/rl_92_116_dpm20_more_500_g3'
    # dst_foldr = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores/rl_resume_72_dpm20_more_500_g3'
    # dst_foldr = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores/rl_alltaskwash_92_dpm20_more_500_g3'
    # dst_foldr = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores/rl_alltask_56_dpm20_more_500_g2'
    ...
    dst_img_p = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.14_11.22_0_eval_nobase_sft_more/edited'
    # dst_img_p = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.10_21.21_0_eval_92rl_more/edited'
    # dst_img_p = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.16_12.21_0_eval_alchemist_more/edited'
    # dst_img_p = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.13_13.22_0_eval_resume_72_more/edited'
    # dst_img_p = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.10_21.21_0_eval_92rl_more/edited'
    # dst_img_p = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.05_17.10_0_eval_2511_base_more_dmp20/edited'
    ...
    for item in tqdm(sub_data):  # 
        ...
        d_img_path = os.path.join(dst_img_p, str(cur_id)+'.png')  
        ...
        #         )
        #         print(response.text)
        #         o2 = parse_eval_output(response.text)
        #         break
        #     except Exception as e:
        #         print(f"❌ Error during visual quality evaluation (attempt {i+1}/3): {e}")
        #         sleep_time = random.uniform(1.0, 2.0)
        #         import time
        #         time.sleep(sleep_time)
        ...
        #         break
        #     except Exception as e:
        #         print(f"❌ Error during consistency evaluation (attempt {i+1}/3): {e}")
        #         sleep_time = random.uniform(1.0, 2.0)
        #         import time
        #         time.sleep(sleep_time)

        # print(response.text)
        # o3 = parse_eval_output(response.text)

        results.append({
            "origin_p": img_path,
            "edited_p": d_img_path,
            "instruction": ins,
            "follow_instruction_score": o1["score"],
