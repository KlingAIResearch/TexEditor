...
if __name__ == "__main__":
    ...
    dst_foldr = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores/rl_simple_blender_dpm20_texture_g3'
    ...
    dst_img_p = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.25_01.02_0_eval_rl_texture/edited'
