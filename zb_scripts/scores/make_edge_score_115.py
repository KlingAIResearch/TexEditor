...
if __name__ == "__main__":
    ...
    dst_foldr_all = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/all_edges_123/score'
    ...
    dst_dir_f = '/mmu-vcg/zb08/outputs/texture_edit/new_model_out/all_edges_123/texture'
    ...
    rl_pure_gemini = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.23_11.18_0_eval_pure_gemini_texture/edited'
    rl_pure_edge = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.23_14.09_0_eval_pure_edge_texture/edited'

    # 先弄texture
    # 这个感觉 texture 和 属性还是分开写吧  

    in_jsonl_p = '/mmu-vcg/zb08/outputs/texture_edit/train_data/rl_data/maybe_v2_final_texture/test_clean_v2.jsonl'
    # in_jsonl_p = '/mmu-vcg/zb08/outputs/texture_edit/train_data/simple_blender_test/texture_index.jsonl'
    # in_jsonl_p = '/mmu-vcg/zb08/outputs/texture_edit/train_data/simple_blender_test/texture_index.jsonl'


    source_imgs_f = '/mmu-vcg/zb08/yihang/enhance_coco_data_12_25/new_data/new_data_texture'
    # img_folder_list = [ rl_72, rl_64, nobase_rl ]
    # img_folder_list = [ gemini3, gemni25, sft_base, rl, origin, qwen_11 ]
    # img_folder_dict = { "rl_72": rl_72, "rl_64": rl_64, "nobase_rl": nobase_rl}
    img_folder_dict = { "rl_pure_gemini": rl_pure_gemini, "rl_pure_edge": rl_pure_edge}
    # img_folder_dict = { "rl_96": rl_96, "alchemist": alchemist}
