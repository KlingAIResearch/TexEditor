...
if __name__ == "__main__":
    ...
    dst_foldr = '/mmu-vcg/zb08/outputs/texture_edit/final_old_scores/rl_simple_blender_dpm20_more_g3'
    ...
    dst_img_p = '/mmu-vcg/zb08/outputs/texture_edit/sft_base/2026.01.25_11.51_0_eval_rl_more/edited'
    ...
    for item in tqdm(sub_data):  # 
        ...
        cccur_id = item['index']
        d_img_path = os.path.join(dst_img_p, str(cccur_id)+'.png')
