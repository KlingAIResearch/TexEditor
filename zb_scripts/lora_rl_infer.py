...
def main(_):
    ...
    # lora_path = '/mmu-vcg/zb08/codes/UniWorld-main/UniWorld-V2/logs/nft/qwen_image_edit/zb_sft_base_bigbs_Coco_normal_kl_all_resume/checkpoints+unique_id/checkpoint-24/lora'
    # lora_path = '/mmu-vcg/zb08/codes/UniWorld-main/UniWorld-V2/logs/nft/qwen_image_edit/zb_sft_base_bigbs_Coco_normal_kl_more/checkpoints+unique_id/checkpoint-42/lora'
    # lora_path = '/mmu-vcg/zb08/codes/UniWorld-main/UniWorld-V2/logs/nft/qwen_image_edit/zb_sft_base_bigbs_Coco_normal_kl_all_resume/checkpoints+unique_id/checkpoint-56/lora'
    # lora_path = '/mmu-vcg/zb08/codes/UniWorld-main/UniWorld-V2/logs/nft/qwen_image_edit/zb_sft_base_bigbs_Coco_normal_kl_allwash/checkpoints+unique_id/checkpoint-92/lora'
    ...
    # lora_path = '/mmu-vcg/zb08/codes/UniWorld-main/UniWorld-V2/logs/nft/qwen_image_edit/zb_sft_base_bigbs_Coco_normal_kl_allwash_resume_112/checkpoints_2026.01.13_02.43.04/checkpoint-64/lora'
    # lora_path = '/mmu-vcg/zb08/codes/UniWorld-main/UniWorld-V2/logs/nft/qwen_image_edit/zb_sft_base_bigbs_Coco_normal_kl_allwash_abla_pure_gemini/checkpoints_2026.01.23_09.26.33/checkpoint-56/lora'
    lora_path = '/mmu-vcg/zb08/codes/UniWorld-main/UniWorld-V2/logs/nft/qwen_image_edit/zb_sft_base_bigbs_Coco_normal_kl_allwash_abla_pure_edge/checkpoints_2026.01.21_18.56.36/checkpoint-20/lora'
