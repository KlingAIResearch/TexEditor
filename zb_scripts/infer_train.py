...
def eval_fn(
    ...
    for all_idx, test_batch in enumerate(tqdm( 
        eval_loader,
        desc="Eval: ",
...
def main(_):
    ...
    # )
    test_dataset = PromptImageDataset(config.dataset, config.resolution, "train")
